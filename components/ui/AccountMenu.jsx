  ...
  return (
    <>
      <Menu as="div" className="relative z-50">
        ...
        >
          <Menu.Items className="bg-react  w-72 max-w-[300x] sm:w-96 dark:text-react absolute right-0 mt-1 flex origin-top-right flex-col rounded-xl py-6 text-white shadow-lg focus:outline-none dark:bg-white">
